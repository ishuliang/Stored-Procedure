create PROCEDURE dbo.up_interface_RIS_WN_getbrlist
(
...
BEGIN
    ...
    -- 插入日志记录
    INSERT INTO dbo.up_interface_RIS_WN_getbrlist_log (brlb, hzxm, ksdm, bqdm, cwdm, rq1, rq2, fph, codetype, zxksdm, jzbrbz)
    ...
    -- 更新日志记录结果
    UPDATE dbo.up_interface_RIS_WN_getbrlist_log 
...
PRINT '存储过程 up_interface_RIS_WN_tjbrcx 已升级完成！'