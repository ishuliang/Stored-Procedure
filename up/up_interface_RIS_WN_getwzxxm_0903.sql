USE [sxzlhems]
GO
/****** Object:  StoredProcedure [dbo].[up_interface_RIS_WN_getwzxxm_0903_test]    Script Date: 2026/9/3 22:06:04 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        WHERE vp.IS_State < 6
          ...
          AND (iss.state =''2'' OR iss.state =''6'' OR iss.apply_no IS NULL)
        ...
        DECLARE @SQL NVARCHAR(MAX) = N'
            ...
            LEFT JOIN interface_state iss ON iss.apply_no = vpfi.applyId
        ' + @Where;
