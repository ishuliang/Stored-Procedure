ALTER PROCEDURE dbo.up_interface_RIS_WN_jg_huishou
(
...
BEGIN
    ...
    -- 插入日志记录
    INSERT INTO dbo.up_interface_RIS_WN_jg_huishou_log (repno, replb, syscode)
    ...
    -- 更新日志记录结果
    UPDATE dbo.up_interface_RIS_WN_jg_huishou_log 
...
PRINT '存储过程 up_interface_RIS_WN_jg_huishou 已升级完成！'