...
BEGIN
    ...
    -- 插入日志记录
    INSERT INTO dbo.up_interface_RIS_WN_bgztxg_log (brlb, patid, curno, ysdm, bgzt, txzt, jczt, bgdh, bglx, logno, lis, txm)
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            ELSE
            BEGIN
                -- RIS系统：按 apply_no + patient_code 防重, TODO 看看用的啥字段来保存的
