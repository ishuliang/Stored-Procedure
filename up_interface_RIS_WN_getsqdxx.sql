...
-- 获取体检影像申请单信息（PACS专用）
-- =============================================
IF OBJECT_ID('dbo.up_interface_RIS_WN_getsqdxx', 'P') IS NOT NULL
    DROP PROCEDURE dbo.up_interface_RIS_WN_getsqdxx
GO

CREATE PROCEDURE dbo.up_interface_RIS_WN_getsqdxx
(
...
BEGIN
    ...
    -- 插入日志记录
    INSERT INTO dbo.up_interface_RIS_WN_getsqdxx_log (brlb, patid, cureno, sqdh)
    ...
    -- 更新日志记录结果
    UPDATE dbo.up_interface_RIS_WN_getsqdxx_log 
...
PRINT '存储过程 up_interface_RIS_WN_getsqdxx 创建成功！'